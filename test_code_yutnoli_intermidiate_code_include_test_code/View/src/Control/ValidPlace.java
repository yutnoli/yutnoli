...
public class ValidPlace {
	...
	boolean[] playerMove = new boolean[6];
	...
	void setValidPlaceMap(int state, int num) {
		...
		for (int i = -1; i < 5; i++) {//get player's move data
		...
		if(playerMove[0]) {
			if(choseState[0] == 0) {
				if(choseState[1] != 0 && choseState[1] != 4 && choseState[1] != 8 && choseState[1] != 12 && choseState[1] != 16 && choseState[1] != 18 && choseState[1] != 20 && choseState[1] != 22)
					data.setValidPlace(0, choseState[1] - 1);
				else if(choseState[1] == 0)
					data.setValidPlace(2, 0);
				else if(choseState[1] == 4 || choseState[1] == 16)
					data.setValidPlace(1, 0);
				else if(choseState[1] == 8 || choseState[1] == 20)
					data.setValidPlace(1, 1);
				else if(choseState[1] == 12)
					data.setValidPlace(1, 2);
				else if(choseState[1] == 18 || choseState[1] == 22)
				...
				if(choseState[1] == 0)
					...
					data.setValidPlace(0, 7);
				else if(choseState[1] == 2)
					data.setValidPlace(0, 11);
		...
		if(playerMove[2]) {
			...
			if(choseState[0] == 0) {
				...
				else if(choseState[1] == 3 || choseState[1] == 7 || choseState[1] == 11 || choseState[1] == 17 || choseState[1] == 21)
					data.setValidPlace(0, choseState[1] + 1);
				else if(choseState[1] == 19)
					data.setValidPlace(0, 12);
				else if(choseState[1] == 2)
					data.setValidPlace(1, 0);
