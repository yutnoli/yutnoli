...
//이미지 넣은 버튼 생성
		...
		newStone = new JButton();
		endStone = new JButton();
		throwYutRandom = new JButton();
		throwYutselect = new JButton();
		

		mapClicked =  new ButtonAction(normalState, cornerCenterState, startState, newStone, endStone, throwYutRandom, throwYutselect);
		for(int i = 0; i < 24; i++) {
		...
		/////////////////////TODO complete temporary button
		newStone.addActionListener(mapClicked);
		...
		/////////////////////TODO complete temporary button
		newStone.setBounds(900, 800, 50, 50);
		endStone.setBounds(900, 700, 50, 50);
		throwYutRandom.setBounds(900, 600, 50, 50);
		throwYutselect.setBounds(900, 500, 50, 50);
